...
docker run -d --name ocrmysql -p 3310:3306 -v $HOME/teletraan/mysql/conf.d:/etc/mysql/conf.d -v $HOME/teletraan/mysql/data:/var/lib/mysql -v $PWD/initScripts:/docker-entrypoint-initdb.d --network=ocr   leo2n/ocrmysql:test
